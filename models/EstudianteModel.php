...
class EstudianteModel{
    ...
    public function listar_Estudiante(){
        try {
            $query= "SELECT * from Usuario where id_tipoUsuario_FK=3 and estado_Usuario='Activo'";
    ...
    public function nuevo_Estudiante(EstudianteModel $data){
        try {
            $query= "CALL PA_Insertar_Usuario(?,?,?,?,?,?,'Activo','3','5')";
            $stm = $this->CNX->prepare($query);
    ...
    public function eliminar_Estudiante($id_Usuario)
	{
		try 
		{
