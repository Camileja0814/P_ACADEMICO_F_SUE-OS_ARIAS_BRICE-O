...
<?php include "./views/modules/cargador.php" ?>
    ...
    <section class="full-box dashboard-contentPage">
        ...
        <div class="container">
            ...
            <div class="titles">
                <h1 class="tituloa ">Cargo</h1>
                <div class="form-group" id="botones">
                    <!--Pará mostrar una línea horizontal en el documento-->
                    <a href="?c=Cargo&a=nuevo" class="boton btn btn-info botones">Nuevo Cargo</a>
            ...
            <table id="table" data-toggle="table" data-height="auto" data-search="true" data-show-refresh="false"
                ...
                <tbody>
                    ...
                    <?php foreach ($this->mode->listar_Cargo() as $k ) : ?>
                    <tr>
                        <th data-field="ID" scope="row"><?php echo $k->id_Cargo; ?></th>
                        <td data-field="cargo"><?php echo $k->nombre_Cargo; ?></td>
                        
                        <th data-field="editar">
                            <div class="form-group" id="botones">
                                <!--Pará mostrar una línea horizontal en el documento-->
                                <a href="?c=Cargo&a=nuevo&id_Cargo=<?php echo $k->id_Cargo;?>"  class="fas fa-user-edit fa-lg " ></a>
                        ...
                        <div class="form-group" id="botones">
                                ...
                                " href="?c=Cargo&a=g_eliminar_Cargo&id_Cargo=<?php echo $k->id_Cargo;?>"
