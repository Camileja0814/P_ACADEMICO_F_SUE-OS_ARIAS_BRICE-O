...
<?php include "./views/modules/cargador.php" ?>
    ...
    <section class="full-box dashboard-contentPage">
        ...
        <div class="container">
            ...
            <div class="titles">
                <h1 class="tituloa ">Especialidad</h1>
                <div class="form-group" id="botones">
                    <!--Pará mostrar una línea horizontal en el documento-->
                    <a href="?c=Especialidad&a=nuevo" class="boton btn btn-info botones">Nuevo Especialidad</a>
            ...
            <table
                ...
                <tbody>
                    ...
                    <tr>
                        <th data-field="ID" scope="row"><?php echo $k->id_Especialidad; ?></th>
                        <td data-field="especialidad"><?php echo $k->nombre_Especialidad; ?></td>
                        <th data-field="editar">
                            <div class="form-group" id="botones">
                                <!--Pará mostrar una línea horizontal en el documento-->
                                <a
                                    href="?c=Especialidad&a=nuevo&id_Especialidad=<?php echo $k->id_Especialidad;?>"
                        ...
                        <th data-field="eliminar">
                            <div class="form-group" id="botones">
                                <!--Pará mostrar una línea horizontal en el documento-->
                                <a
                                    onclick="javascript:return confirm('¿Desea eliminar la especialidad?');
                                "
                                    href="?c=Especialidad&a=g_eliminar_Especialidad&id_Especialidad=<?php echo $k->id_Especialidad;?>"
