...
<?php include "./views/modules/cargador.php" ?>
    ...
    <section class="full-box dashboard-contentPage">
        ...
        <div class="container">
            ...
            <div class="titles">
                <h1 class="tituloa ">Tipo Usuario</h1>
                <div class="form-group" id="botones">
                    <!--Pará mostrar una línea horizontal en el documento-->
                    <a href="?c=TipoUsuario&a=nuevo" class="boton btn btn-info botones">Nuevo Tipo de Usuario</a>
            ...
            <table id="table" data-toggle="table" data-height="auto" data-search="true" data-show-refresh="false"
                ...
                <tbody>
                    ...
                    <?php foreach ($this->mode->listar_TipoUsuario() as $k ) : ?>
                    <tr>
                        <th data-field="ID" scope="row"><?php echo $k->id_tipoUsuario; ?></th>
                        <td data-field="TipoUsuario"><?php echo $k->nombre_Tipo_Usuario; ?></td>
                        
                        <th data-field="editar">
                            <div class="form-group" id="botones">
                                <!--Pará mostrar una línea horizontal en el documento-->
                                <a href="?c=TipoUsuario&a=nuevo&id_tipoUsuario=<?php echo $k->id_tipoUsuario;?>"  class="fas fa-user-edit fa-lg " ></a>
                        ...
                        <div class="form-group" id="botones">
                                ...
                                " href="?c=tipoUsuario&a=g_eliminar_TipoUsuario&id_tipoUsuario=<?php echo $k->id_tipoUsuario;?>"
